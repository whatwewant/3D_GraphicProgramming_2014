...
public:
	...
	inline float VectorDot (const CVector3D &v1, const CVector &v2) {
		return v1.x*v2.x + v1.y*v2.y + v1.z*v2.z;
	}

	inline CVector3D VectorCross (const CVector3D &v1, const CVector &v2) {
		return CVector3D (
			v1.y*v2.z - v1.z*v2.y,
			v1.z*v2.x - v1.x*v2.z,
			v1.x*v2.y - v1.y*v2.z
...
public:
	...
	// Single
	inline CQuaternion operator - (const CQuation &q) {
	...
	inline CQuaternion operator + (const CQuation &q1, const CQuation &q2) {
